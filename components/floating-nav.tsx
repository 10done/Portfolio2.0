...
export default function FloatingNav() {
  ...
  const socialLinks: SocialLink[] = [
    {
      icon: FileText,
      href: "https://drive.google.com/file/d/1WqTkhB67OVBvYehFXRqTgI-Z0pMsfro5/view?usp=sharing",
      label: "Resume",
    },
    {
      icon: Github,
    ...
    {
      icon: Linkedin,
      href: "https://www.linkedin.com/in/anubhav-tandon-9b8737245/",
      label: "LinkedIn",
    },
    {
      icon: Mail,
      href: "mailto:anubhavtandon6424@gmail.com",
      label: "Email",
    },
  ];
